...
/// Integrated ExtroPOS Main Screen with Database Repository
/// 
/// Features:
/// - Repository pattern for clean data access
/// - Mode-based filtering (Retail/Cafe/Restaurant)
/// - Real-time cart management with setState()
...
extension POSModeExtension on POSMode {
  String get value {
    switch (this) {
      case POSMode.retail:
        return 'retail';
...
class _MainPOSScreenState extends State<MainPOSScreen> {
  ...
  // Mode is passed from parent UnifiedPOSScreen or detected from BusinessInfo
  // For this example, we'll use a default mode
  POSMode activeMode = POSMode.cafe;

  // --- Dynamic Data State (from repository) ---
  ...
  /// Fetch products and categories from repository based on active mode
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _sidebarItem(Icons.shopping_bag_outlined, 'POS',
                    isActive: activeTab == 'POS'),
                if (activeMode == POSMode.restaurant)
                  _sidebarItem(Icons.table_bar_outlined, 'Tables',
                      isActive: activeTab == 'Tables'),
                _sidebarItem(Icons.bar_chart_rounded, 'Reports',
  ...
  // Mode switching is handled by parent UnifiedPOSScreen
  // This example can be integrated into your existing mode-switching flow
            ...
            child: Center(
                child: Text(
                    item.product.category.isNotEmpty
                        ...
                        : '?',
                    style: const TextStyle(
                        fontWeight: FontWeight.bold, opacity: 0.3))),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    _qtyBtn(
                        Icons.add, () => updateQuantity(item.product.id, 1)),
                  ],
                )
              ],
            ),
      ...
      children: [
        ...
        Text(value,
            style: TextStyle(
                ...
                fontWeight: isTotal ? FontWeight.black : FontWeight.bold)),
      ],
    );
  }
  ...
  Widget _buildMainView() {
    switch (activeTab) {
      ...
      default:
        return Center(
            child: Text('$activeTab View (Coming Soon)',
